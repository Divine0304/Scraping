...
BASE_URL = "https://www.amazon.fr/s?k=shiseido&page={}"
NB_PAGES = 3
...
with open("shiseido_amazon.csv", "w", newline="", encoding="utf-8") as fichier:
    ...
    for page in range(1, NB_PAGES + 1):
        ...
        print(f"Scraping Shiseido - Page {page}...")
        ...
        for p in produits:
            ...
            try:
                ...
                categorie = "Cosmétique de Luxe et Soins"
...
print("Fichier créé : shiseido_amazon.csv")