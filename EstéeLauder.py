...
BASE_URL = "https://www.amazon.fr/s?k=estee+lauder&page={}"
NB_PAGES = 3
...
with open("estee_lauder_amazon.csv", "w", newline="", encoding="utf-8") as fichier:
    ...
    for page in range(1, NB_PAGES + 1):
        ...
        print(f"Scraping Estée Lauder - Page {page}...")
...
print("Fichier créé : estee_lauder_amazon.csv")